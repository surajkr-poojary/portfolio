  ...
  return (
    ...
    >
      ...
      <main className="flex flex-col gap-6 sm:gap-8 row-start-2 items-center text-center w-full max-w-4xl mx-auto fade-in">
        ...
        >
          I’m a passionate developer with 1.3 years of experience in building
          high-quality, dynamic, and responsive websites using Next.js, React.js,
          and TailwindCSS. I’ve worked extensively on e-commerce solutions, API
      ...
      <section id="about" className="fade-in w-full text-center mt-12 px-4">
        ...
        >
          I specialize in creating dynamic and responsive web applications. With
          my passion for coding and eye for design, I build exceptional web
          experiences using modern technologies like Next.js, React.js, and
          TailwindCSS. I'm always striving to learn more and improve my craft.
        </p>
        </FadeIn>
      </section>

      {/* Skills Section */}
      <section id="skills" className="fade-in w-full text-center mt-16 sm:mt-24 px-4">
        <h2
      ...
      {/* Projects Section */}
      <section id="projects" className="fade-in w-full text-center mt-8 sm:mt-12 px-4">
        <h2
          className={`text-3xl sm:text-5xl md:text-6xl font-bold mt-6 sm:mt-8 border-b-2 pb-2 font-montserrat ${
            isDarkTheme ? "text-white border-white" : "text-black border-black"
          }`}
